                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                                ...
                                <div style={{ position: 'relative' }} ref={modelMenuRef}>
                                    ...
                                    >
                                        <svg width="15" height="15" viewBox="0 0 150 216" fill="currentColor">
                                            <path d="M105.304012.00401184C47.7040118-.49598816.50401184 45.8040118.00401184 103.404012c-.5 57.6 45.79999996 104.8 103.40000016 105.3h36.2v-39.1h-34.3c-36.0000002.4-65.6000002-28.4-66.0000002-64.5-.4-36.1000002 28.4-65.6000002 64.5000002-66.00000016h76v-39.1c-22.60000004-.3-45.30000004-.69999996-67.90000016-.69999996z" />
                                        </svg>
                                        Groq Llama 3
                                    ...
                                    <div style={{
                                        ...
                                        {[
                                            { id: 'llama3-70b', name: 'Llama 3.3 70B', iconPath: 'M105.304012.00401184C47.7040118-.49598816.50401184 45.8040118.00401184 103.404012c-.5 57.6 45.79999996 104.8 103.40000016 105.3h36.2v-39.1h-34.3c-36.0000002.4-65.6000002-28.4-66.0000002-64.5-.4-36.1000002 28.4-65.6000002 64.5000002-66.00000016h76v-39.1c-22.60000004-.3-45.30000004-.69999996-67.90000016-.69999996z', desc: 'Highest reasoning' },
                                            { id: 'llama3-8b', name: 'Llama 3.1 8B', iconPath: 'M105.304012.00401184C47.7040118-.49598816.50401184 45.8040118.00401184 103.404012c-.5 57.6 45.79999996 104.8 103.40000016 105.3h36.2v-39.1h-34.3c-36.0000002.4-65.6000002-28.4-66.0000002-64.5-.4-36.1000002 28.4-65.6000002 64.5000002-66.00000016h76v-39.1c-22.60000004-.3-45.30000004-.69999996-67.90000016-.69999996z', desc: 'Instant responses' },
                                        ].map(m => (
                                            ...
                                            onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                                            >
                                                <svg width="16" height="16" viewBox="0 0 150 216" fill="var(--text-2)" style={{ flexShrink: 0 }}>
                                                    <path d={m.iconPath} />
                                                </svg>
                                        ...
                                        {[
                                            { id: 'gemini-2-flash', name: 'Gemini 2.0 Flash', iconPath: 'M11.04 19.32Q12 21.51 12 24q0-2.49.93-4.68.96-2.19 2.58-3.81t3.81-2.55Q21.51 12 24 12q-2.49 0-4.68-.93a12.3 12.3 0 0 1-3.81-2.58 12.3 12.3 0 0 1-2.58-3.81Q12 2.49 12 0q0 2.49-.96 4.68-.93 2.19-2.55 3.81a12.3 12.3 0 0 1-3.81 2.58Q2.49 12 0 12q2.49 0 4.68.96 2.19.93 3.81 2.55t2.55 3.81', desc: 'Speed & multimodality' }
                                        ].map(m => (
                                            <button key={m.id} type="button" onClick={(e) => { e.preventDefault(); setModelMenuOpen(false); toast?.(`Switched to ${m.name}.`, 'success'); }} style={{
                                                display: 'flex', alignItems: 'center', gap: 10,
                                                padding: '6px 10px', borderRadius: 10, border: 'none',
